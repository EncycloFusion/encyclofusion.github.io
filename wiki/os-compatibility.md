...
- [Multimedia Fusion 2](/fusion/2.0/) can officially be run and exported for **Windows 98 Second Edition** and newer. Apps made using MMF2 and lower can also be run and exported for Windows 95,NT 4.0 and 98FE.
