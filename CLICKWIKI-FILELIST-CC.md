**The following files in this list were taken or adapted from [ClickWiki](https://github.com/ClickWiki/clickwiki.github.io) and its contributors, which licensed them under [CC BY 4.0](/LICENSE-CC-BY-4.0), unless the file is owned by a brand, in which case we would be using it under "Fair Use".**
